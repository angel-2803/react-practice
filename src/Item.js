...
class Item extends React.Component{
    ...
    onChangeRating= (e) =>{
        ...
        this.props.onupdaterating({id: this.state.id, title: this.state.title, imagen: this.state.imagen, rating: rating});
    }
    ...
    render(){
        return(
            <div className="item">
                <div className="image"> <img src={'img/' + this.state.imagen} width="100%" /> </div>
